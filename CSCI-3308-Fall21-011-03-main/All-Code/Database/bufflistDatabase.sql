...
CREATE TABLE IF NOT EXISTS Users (
	...
	--TODO: Some semblance of security
	email varchar(255),
	pword varchar(255),
	joinDate timestamp
);
...
VALUES (1, 'Selling', 1, '20210901 10:30:05 AM', 'Physics Textbooks', 'I''m graduating and selling all of the textbooks a physics major would need for a standard 4 year track as a bundle.', 100, 40.005833, -105.257718, FALSE),
...
VALUES (1, 'John Doe', 'john@doe.com', 'john123', '20210901 10:30:05 AM'),
	(2, 'Sophie Smith', 'sophie@smith.com', 'Sophie357!', '20211001 08:38:09 AM'),
	(3, 'Nick Brown', 'nick@brown.com', 'nickb123', '20211007 02:30:24 PM'),
	(4, 'Lisa Sanders', 'lisa@sanders.com', 'Lis@1999', '20211013 08:50:38 PM'),
	(5, 'Bob Ross', 'bob@ross.com', 'b0br0ss123', '20211018 11:10:55 AM');

INSERT INTO Pics(PicID, ListingID, link, altText)
VALUES (1, 1, 'https://images-na.ssl-images-amazon.com/images/I/512yEu6OOPL._SX346_BO1,204,203,200_.jpg', 'physics textbook'),
...
--For Dev Purposes:
INSERT INTO Users(UserId, screenName, email, pword, joinDate)
VALUES (-1, 'RalphieDev', 'trevor.liss@colorado.edu', 'bufflistPass', '20211101 11:03:55 AM');